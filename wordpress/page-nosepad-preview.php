...
<header class="global-header">
  <div class="header-inner">
   <a href="https://www.aimegane.com" class="header-back"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/nosepad/AI.svg" alt="アイメガネ" class="header-logo-img"></a>
...
<section class="problem">
  <div class="container">
    ...
    <p class="problem-lead reveal">小さなパーツひとつで、<strong>メガネの印象が変わります。</strong></p>
  </div>
</section>
  ...
  <div class="container">
    <div class="about-inner">
      ...
      <div class="about-text reveal reveal-d1">
        ...
        <p class="about-collab-note">＊本商品はファイテン社の独自技術を取り入れたコラボレーション商品です。</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="faq-list reveal">
      ...
      <div class="faq-item">
        <button class="faq-q" aria-expanded="false">
          <span class="faq-q-left">
            <span class="faq-q-label">Q</span>
            <span class="faq-q-text">金属アレルギーでも使えますか？</span>
          </span>
          <span class="faq-icon">＋</span>
        </button>
        <div class="faq-a">パッドはソフト樹脂製ですので、金属が直接肌に触れることはありません。ご心配な場合は店舗スタッフにご相談ください。</div>
      </div>
    </div>
  </div>
</section>
